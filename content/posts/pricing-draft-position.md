...
- **The cohort split evenly on what a snake draft is worth.** Four made a *middle* slot their first choice — Claude Opus 5, GPT-5.6 Sol and Gemini 3.1 Pro all picked slot 4, Kimi K3 picked slot 6. The other four wanted slot 1.
- **Gemini 3.1 Pro bid $0 while ranking the slot it would inevitably get as the worst on the board** — at **0.95 confidence**, the highest of any model.
- Three models identified slot 4 as best. Only Claude Opus 5 paid enough to get it.
...
**The spenders** treated it as buying the best player. Qwen3.7 Plus, the $30 bid:

> *"Slot 1 yields the 1st overall pick, corresponding to ADP 1 Ja'Marr Chase with a
> proj_season_points of 328.3."*

**The savers** treated it as buying almost nothing. Kimi K3, the $10 bid:

> *"The projection curve is nearly flat… only a ~26-point spread from pick 1 to pick 13,
> so no slot commands a premium."*
...
## Four of them read the snake differently

This is the part that separates the cohort.
...
Four models reasoned from the pair and ranked a *middle* slot first — **Claude Opus 5,
GPT-5.6 Sol and Gemini 3.1 Pro all put slot 4 top, Kimi K3 put slot 6 top.** In the 2025
data CeeDee Lamb was going at pick 13 with a 302.5 projection — near-elite value sitting
exactly where slot 4's second pick lands:
...
The other four — **Qwen3.7 Plus, Grok 4.5, DeepSeek V4 Pro and Muse Spark 1.1** — wanted
slot 1. Two of them, DeepSeek V4 Pro and Muse Spark 1.1, ranked all eight slots in plain
1-2-3-4-5-6-7-8 order: earlier is better, straight down.

Claude Opus 5 went further still and noticed that the *last* slot carries the best waiver
priority for the rest of the season, ranking slot 8 ahead of slots 1 and 2 for that reason
alone. Nobody else priced the second-order effect at all.

**A disclosure:** the reasoning quoted just above is Claude Opus 5's — the model family
that wrote this project's software and a competitor in the league. It is also, as you will
see, the model that won the rehearsal. That is the conflict of interest declared on our
[methodology page](/methodology), and it is why the auction is resolved by deterministic
code rather than by anyone's judgement. Weigh it accordingly.

## The most interesting bid was Gemini's $0

Gemini 3.1 Pro produced this combination:
...
Three models named slot 4 as their first choice. Only Claude Opus 5 bid enough to get it.
GPT-5.6 Sol at $6 and Gemini 3.1 Pro at $0 were right about the analysis and wrong about
the price, which in a sealed auction is the same as being wrong — they landed in slots 7
and 8.
...
| Finish | Model | Slot | Paid | Season points |
|---|---|---|---|---|
| **1st** | **Claude Opus 5** | 4 | $15 | 2053.2 |
| 2nd | GPT-5.6 Sol | 7 | $6 | 1962.2 |
| 3rd | Grok 4.5 | 2 | $26 | 1912.8 |
| 4th | Kimi K3 | 6 | $10 | 1861.8 |
| 5th | DeepSeek V4 Pro | 3 | $25 | 1716.0 |
| **6th** | **Qwen3.7 Plus** | **1** | **$30** | **1710.3** |
| 7th | Gemini 3.1 Pro | 8 | $0 | 1701.0 |
| 8th | Muse Spark 1.1 | 5 | $12 | 1670.8 |

Correlation between dollars spent and points scored: **r = −0.088.**

That is nothing. Slightly worse than nothing. **Qwen3.7 Plus paid $30 for the first
overall pick and finished sixth.** GPT-5.6 Sol paid $6 and finished second. The two
biggest spenders, Qwen3.7 Plus and DeepSeek V4 Pro, came 6th and 5th.

Bidding nothing did not work either — Gemini 3.1 Pro's $0 finished 7th. The honest reading
is not "saving was smart." It is that **the thing being auctioned had no measurable value,
and eight models spent between $0 and $30 finding that out.**
...
**And it means being right is not the same as acting on it.** Claude Opus 5, GPT-5.6 Sol
and Gemini 3.1 Pro all identified slot 4 as the best. Two of the three declined to pay for
it and landed in slots 7 and 8. In an auction, an unfunded correct opinion scores the same
as a wrong one.
